...
```python
# Emare Hosting — Yetki Tanımları
PROJE_PERMISSIONS = [
    # Temel
    'Emare Hosting.view',      # Görüntüleme
    'Emare Hosting.create',    # Oluşturma
    'Emare Hosting.edit',      # Düzenleme
    'Emare Hosting.delete',    # Silme
    'Emare Hosting.manage',    # Tam yönetim
    # Admin
    'Emare Hosting.admin',     # Admin panele erişim
    'Emare Hosting.users',     # Kullanıcı yönetimi
    'Emare Hosting.settings',  # Ayar yönetimi
]
```
...
```python
# Emare Hosting/auth/rbac.py — Kopyala, uyarla, kullan.
...
PERMISSIONS = {
    'super_admin': {'*'},
    'admin': {
        'Emare Hosting.view', 'Emare Hosting.create',
        'Emare Hosting.edit', 'Emare Hosting.delete',
        'Emare Hosting.manage', 'Emare Hosting.users',
        'Emare Hosting.settings', 'Emare Hosting.admin',
    },
    'operator': {
        'Emare Hosting.view', 'Emare Hosting.create',
        'Emare Hosting.edit',
...
| Proje Admini | admin@Emare Hosting.emare.dev | admin | Proje yöneticisi |
| API Servisi | api@Emare Hosting.emare.dev | super_admin | Machine-to-machine |
